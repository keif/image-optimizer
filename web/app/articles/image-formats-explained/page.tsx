  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <article className="prose dark:prose-invert max-w-none">
        ...
        <h2>Introduction to Image Formats</h2>
        <p>
        ...
        <h2>AVIF (AV1 Image File Format)</h2>
        <p>
          ...
          <table className="min-w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
            <thead>
              <tr className="bg-gray-100 dark:bg-gray-700">
                <th className="px-4 py-3 text-left border-b border-gray-200 dark:border-gray-600">Feature</th>
                <th className="px-4 py-3 text-left border-b border-gray-200 dark:border-gray-600">JPEG</th>
                <th className="px-4 py-3 text-left border-b border-gray-200 dark:border-gray-600">PNG</th>
                <th className="px-4 py-3 text-left border-b border-gray-200 dark:border-gray-600">WebP</th>
                <th className="px-4 py-3 text-left border-b border-gray-200 dark:border-gray-600">AVIF</th>
                <th className="px-4 py-3 text-left border-b border-gray-200 dark:border-gray-600">GIF</th>
              </tr>
            </thead>
            <tbody className="text-sm">
              <tr>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 font-medium">Compression</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">Lossy</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">Lossless</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">Both</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">Both</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">Lossless</td>
              </tr>
              <tr className="bg-gray-50 dark:bg-gray-800">
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 font-medium">Transparency</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">No</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">Yes (Alpha)</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">Yes (Alpha)</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">Yes (Alpha)</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">Yes (Binary)</td>
              </tr>
              <tr>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 font-medium">Animation</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">No</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">No</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">Yes</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">Yes</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">Yes</td>
              </tr>
              <tr className="bg-gray-50 dark:bg-gray-800">
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 font-medium">Browser Support</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">100%</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">100%</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">~95%</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">~85%</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">100%</td>
              </tr>
              <tr>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 font-medium">Best For</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">Photos</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">Graphics, Logos</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">Everything</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">High-quality Photos</td>
                <td className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">Simple Animation</td>
              </tr>
            </tbody>
          </table>
        </div>

        <h2>Choosing the Right Format: Decision Guide</h2>
        <p>
          Here's a practical decision tree to help you choose the right format for your images:
        </p>

        <h3>For Photographs and Complex Images</h3>
        <ol>
          <li>
        ...
        <h3>For Graphics, Logos, and Illustrations</h3>
        <ol>
          <li>
        ...
        <h3>For Images with Transparency</h3>
        <ol>
          <li>
        ...
        <h2>Implementing Format Selection</h2>
        <p>
