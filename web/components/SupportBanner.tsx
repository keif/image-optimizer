...
export default function SupportBanner() {
  ...
  return (
    <div className="fixed bottom-4 right-4 max-w-sm bg-linear-to-r from-purple-500 to-pink-500 text-white rounded-lg shadow-lg p-4 z-50">
      <button
      ...
      <div className="flex items-start gap-3">
        <Heart className="w-6 h-6 mt-1 shrink-0" fill="currentColor" />
        <div>
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs px-3 py-1.5 bg-white/20 backdrop-blur-xs rounded-md font-medium hover:bg-white/30 transition-colors"
            >
              GitHub Sponsors
            </a>
          </div>
